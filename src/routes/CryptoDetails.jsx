...
export const CryptoDetails = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: ` $${
        ...
        millify(data?.market_data.high_24h.usd)
      }`,
      icon: <TrophyOutlined />,
    },
  ];
  ...
  const genericStats = [
    ...
    },
    {
      title: "Total Supply",
      value: ` $${
        data?.market_data.max_supply && millify(data?.market_data.max_supply)
      }`,
      icon: <ExclamationCircleOutlined />,
    },
    {
  ...
  return (
    <Col className="coin-detail-container">
      ...
      >
        {time.map((date) => (
          <Radio buttonStyle="solid" value={date}>
            {date}
          </Radio>
        ))}
      </Radio.Group>
