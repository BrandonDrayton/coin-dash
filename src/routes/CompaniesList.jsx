                            ...
                            <Panel
                                ...
                                header={(
                                    <Row key={i} >
                                        ...
                                        <Col className='exchangeSpan' span={5}>${millify(exchange.total_holdings)}</Col>
                                        <Col className='exchangeSpan' span={5}>{millify(exchange.total_entry_value_usd)}</Col>
                                        <Col className='exchangeSpan' span={5}>{millify(exchange.total_current_value_usd)}</Col>
                                        <Col className='exchangeSpan' span={4}>{exchange.percentage_of_total_supply}%</Col>
                                    </Row>
                                )}
                            >
                            </Panel>
